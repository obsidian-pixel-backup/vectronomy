export class SimulationEngine {
    ...
    start(speed = 5) {
        ...
        const elements = Array.from(viewport.querySelectorAll('path, rect, circle, ellipse, polygon, polyline, line'));
    ...
    updateHead(head, crossX, crossY, pt) {
